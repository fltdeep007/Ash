...
export default function SkyCube() {
  // const ref = useRef()
...
void main()
{
  ...
  // var theta = Math.PI * (uniforms.inclination.value - 0.5)
  // var phi = 2 * Math.PI * (uniforms.azimuth.value - 0.5)
  ...
  return (
    <group name="skyGroup" scale={[100, 100, 100]} position={[0, 0, 0]} dispose={null}>
      <mesh>
